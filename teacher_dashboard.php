...
$query = "SELECT username, email FROM teacher WHERE id = ?";
...
mysqli_stmt_bind_result($stmt, $teacher_name, $teacher_email);
...
<body style="margin: 0; background-image: url(images/back.jpg); background-size: cover; background-repeat: no-repeat;">
  ...
  <div class="navbar">
    ...
    <ul>
        ...
        <li><svg width="306.79999999999995" height="75.69771640216716"
      ...
      <button style="border-radius: 50%;padding: 20px; color: black; background: linear-gradient(45deg, red, yellow); float: left; " onclick="openPopup()">A</button>
      ...
      <div id="popup" class="popup">
          ...
          <p>Username:-<?php echo $teacher_name; ?></p>
          
          
          <p>UserID:-<?php echo $n; ?></p> 
...
<li><a href="#" onclick="loadContent('teacher section/your_profile.php')">Profile</a></li>

  <li><a href="#" onclick="loadContent('content4.php')">Current Openings</a></li>

  <li><a href="#" onclick="loadContent('content2.php')">Resume</a></li>
  <li><a href="#" onclick="loadContent('content1.php')">Update Information</a></li>




  <li><a href="#" onclick="loadContent('content3.php')">Analytics</a></li>
